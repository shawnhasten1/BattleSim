...
export const FIELD_COPY: Record<string, FieldCopy> = {
  ...
  "spell.healChosenCount": { label: "Up to how many creatures", hint: "e.g. 6 for Prayer of Healing" },
  ...
  "spell.buffTarget": { label: "Who's buffed", hint: '"The caster" for a self-buff; "several creatures" for Bless-style up-to-N targeting' },
  "spell.buffChosenCount": { label: "Up to how many creatures", hint: "e.g. 3 for Bless" },
  "spell.buffDurationRounds": { label: "Duration (rounds)" },
  "spell.buffAcBonus": { label: "AC bonus", hint: "Shield of Faith: +2" },
  "spell.buffAttackRollBonus": { label: "Attack roll bonus" },
  "spell.buffSaveBonus": { label: "Saving throw bonus (all abilities)", hint: 'Bless\'s +1d4 is approximated as a flat +2 — conditions can\'t roll their own dice here. For a bonus that varies by ability, use "Other effects" below instead.' },
